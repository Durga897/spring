                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="card-img-top" alt="product"
                                 src="getProductImage/<c:out value='${list.product.id}'/>"
                                 style="width:90px;height:90px">
                        </div>
                        <div class="col-md-6">
                            <p class="card-text"><b>${list.product.name}</b></p>
                            <p class="card-title">${list.quantity}</p>
                            <p class="card-title"><b>&#8377;${list.price}</b></p>
                        </div>
                    </div>
                </c:forEach>
            </div>
