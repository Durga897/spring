...
<div class="center">
    ...
    <button class="btn-primary">
        <a href="http://localhost:8080/ecommarceApplication/product/getAll" style="color: #FFFFFF">Shop Now</a></button>
</div>
<div class="card">
...
<c:forEach items="${cartItem }" var="list">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <img class="card-img-top" src="getProductPhoto/<c:out value='${list.productId}'/>"
