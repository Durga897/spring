...
<br><br><br>
<div class="center">
    <img src="https://www.clipartmax.com/png/full/62-624281_check-circle-ring-correct-right-mark-character-check-mark-icon-png.png" alt="empty">
    <p>Your profile updated</p>
    <button class="btn-primary">
        <a href="fetchProduct" style="color: #FFFFFF">Shop continue</a></button>
</div>
</body>
</html>
